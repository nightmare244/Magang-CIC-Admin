...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('foto_profil')->nullable()->comment('Path ke file foto');

            // Relasi ke Departemen
            // Kita gunakan constrained() untuk foreign key yang rapi.
            // nullable() agar bisa kosong, onDelete('set null') agar jika departemen dihapus, user tidak ikut terhapus.
