...
<head>
    ...
    <style>
        ...
        /* Header Match dengan Style Otorisasi */
        ...
        /* Button Style Match dengan Konfirmasi */
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="description">Sistem mendeteksi permohonan izin baru yang memerlukan tinjauan Anda. Berikut adalah rincian data karyawan:</p>
            ...
            <div class="info-box">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><span class="status-badge">{{ $izin->tipe_izin }}</span></td>
                    </tr>
                    <tr>
            ...
            <div class="btn-group">
                ...
                <a href="{{ $urlSetuju }}" class="btn btn-approve">Setujui</a>
                <a href="{{ $urlTolak }}" class="btn btn-reject">Tolak</a>
            </div>
        </div>

        <div class="footer">
            <p class="footer-text">Ciwangun Indah Camp • Asset Management</p>
        </div>
    </div>
</body>
</html>