...
const submitForm = async () => {
  ...
  try {
    const res = await api.post('/admin/pengeluaran', form.value)
    const msg = res.data?.message || 'Data pengeluaran berhasil ditambahkan.'
    ...
    const errMsg = error.response?.data?.message || 'Gagal menambahkan data pengeluaran.'
    errorMessage.value = 'GAGAL MENAMBAHKAN PENGELUARAN'
